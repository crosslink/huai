...
#s5_md_search_wrap label, #s5_md_search_wrap br {
display:none;
}
...
#s5_md_mobile_top_1_wrap .moduletable, #s5_md_mobile_bottom_1_wrap .moduletable, #s5_md_main_content_wrap {
background:#ffffff;
padding:0px;
padding:12px;
border:1px solid #DFDFDF;
...
#s5_md_mobile_top_1_wrap .moduletable h3, #s5_md_mobile_bottom_1_wrap .moduletable h3 {
border:1px solid #DFDFDF;
background:#FAFAFA;
background: -moz-linear-gradient(top, #FFFFFF 0%, #F9F9F9 100%); /* FF3.6+ */
background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#FFFFFF), color-stop(100%,#F9F9F9)); /* Chrome,Safari4+ */
...
#s5_md_mobile_top_2_wrap .moduletable, #s5_md_mobile_bottom_2_wrap .moduletable {
color:#FFFFFF;
background:#1A1A1A;
padding:0px;
padding:12px;
...
#s5_md_mobile_top_2_wrap .moduletable h3, #s5_md_mobile_bottom_2_wrap .moduletable h3 {
color:#FFFFFF;
...
#s5_header_area_inner2, #s5_header_wrap, #s5_search input, .module_round_box, .module_round_box-dark, #s5_component_wrap, #s5_footer_area_inner2, .inputbox, .registration input, .login input, #jform_contact_message, .contact-form input, .padded, .padded:hover {
behavior: url(templates/shape5_vertex/css/PIE.htc);
position:relative;
}

.module_round_box .s5_mod_h3 {
background:url(../images/internet_explorer/s5_mod_h3.png) repeat-x bottom left;
}

.module_round_box-dark .s5_mod_h3 {
background:url(../images/internet_explorer/s5_mod_h3_dark.png) repeat-x bottom left;
}
