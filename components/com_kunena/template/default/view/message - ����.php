...
<span class="kmsgtitl"<?php echo $this->escape($this->msgsuffix) ?> kmsg-title-bottom">
			<?php echo $this->subjectHtml ?>
		</span>
&nbsp;&nbsp;
		
		<span  class="ktopic-posted-time" title="<?php echo CKunenaTimeformat::showDate($this->msg->time, 'config_post_dateformat_hover') ?>">
			<?php echo CKunenaTimeformat::showDate($this->msg->time, 'config_post_dateformat') ?>
		</span>
